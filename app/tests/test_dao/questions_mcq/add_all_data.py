...
print(
    f"➡ length of multiple_choice_question_entries: {len(multiple_choice_question_entries)}"
)
...
for selected_mcq in multiple_choice_question_entries:
    ...
    if not mcq_obj:
        ...
        session.commit()
        print("=====================> MCQ Data added successfully!!!")
    else:
        print("=====================> This Question is already Added!!!")
        for obj in mcq_obj:
            duplicate_questions.append(obj.question)
